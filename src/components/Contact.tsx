          ...
          <div className="contact-info space-y-8">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                ...
                amazing people. Whether you need a website, web application, or
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl bg-violet-500/5 border border-violet-500/20 text-white placeholder-gray-500 focus:outline-none focus:border-violet-500/50 transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 rounded-xl bg-violet-500/5 border border-violet-500/20 text-white placeholder-gray-500 focus:outline-none focus:border-violet-500/50 transition-colors resize-none"
