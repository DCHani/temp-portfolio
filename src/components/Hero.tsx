...
const roles = ["Full Stack Developer", "Machine Learning Engineer", "Problem Solver"];
            ...
            <div className="hero-content space-y-8">
              ...
              <div className="space-y-3">
                <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight leading-[0.9]">
                  ...
                  <span className="block mt-2">
                    ...
                    <span className="text-zinc-600">Benchalel</span>
                  </span>
                </h1>
              ...
              <div className="flex flex-wrap items-center gap-x-8 gap-y-4 pt-4">
                ...
                <a href="/Azzeddine Hani Benchalel.pdf" download className="group relative text-zinc-500 font-medium text-lg hover:text-zinc-300 transition-colors duration-200 flex items-center gap-2">
                  ...
                  <span>Resume</span>
                  <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-zinc-500 group-hover:w-full transition-all duration-300" />
                </a>
              </div>
            ...
            <div className="hero-visual relative flex items-center justify-center lg:justify-end">
              <div className="hero-float relative w-[340px] h-[340px] sm:w-[420px] sm:h-[420px] lg:w-[500px] lg:h-[500px]">
                ...
                <div className="orbit-ring absolute inset-0">
                  ...
                  <div className="orbit-item absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <div className="orbit-item-inner px-4 py-2 bg-zinc-900/90 backdrop-blur-sm border border-zinc-700/50 rounded-full shadow-lg shadow-violet-500/10">
                      <span className="text-sm font-medium text-zinc-300">React</span>
                    </div>
                  </div>
                  ...
                  <div className="orbit-item absolute right-0 top-1/2 translate-x-1/2 -translate-y-1/2">
                    <div className="orbit-item-inner px-4 py-2 bg-zinc-900/90 backdrop-blur-sm border border-zinc-700/50 rounded-full shadow-lg shadow-cyan-500/10">
                      <span className="text-sm font-medium text-zinc-300">Node.js</span>
                    </div>
                  </div>
                  ...
                  <div className="orbit-item absolute bottom-[15%] left-[15%]">
                    <div className="orbit-item-inner px-3 py-1.5 bg-zinc-900/90 backdrop-blur-sm border border-zinc-700/50 rounded-full">
                      <span className="text-xs font-medium text-zinc-400">TensorFlow</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute inset-[15%] rounded-full bg-gradient-to-br from-zinc-800/80 to-zinc-900/80 border border-zinc-700/50 shadow-2xl shadow-black/50 overflow-hidden">
                  ...
                  {/* Profile image */}
                  <div className="absolute inset-4 rounded-full overflow-hidden border-2 border-zinc-600/50">
                    <img
