  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.from(".hero-badge", { opacity: 0, y: -20, duration: 0.6 })
        ...
        .from(".hero-stat", { opacity: 0, y: 30, stagger: 0.1, duration: 0.5 }, "-=0.2");
    }, heroRef);
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden grid-bg">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        {/* Typewriter Role */}
        <div className="hero-role h-12 mb-8">
        ...
        {/* Description */}
        <p className="hero-description max-w-2xl mx-auto text-gray-400 text-lg mb-10 leading-relaxed">
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <div
              key={index}
              className="hero-stat p-4 rounded-xl bg-violet-500/5 border border-violet-500/10 backdrop-blur-sm"
            >
